...
//#define K_DRIVER_TYPE  TMC2209_STANDALONE
//#define U_DRIVER_TYPE  TMC2209_STANDALONE
//#define V_DRIVER_TYPE  TMC2209_STANDALONE
//#define W_DRIVER_TYPE  TMC2209_STANDALONE
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  41.15,  41.15 }
    #define DEFAULT_Ki_LIST {   3.46,   3.46 }
    #define DEFAULT_Kd_LIST {  122.20,  122.20 }
  #else
    #define DEFAULT_Kp 41.15
    #define DEFAULT_Ki 3.46
    #define DEFAULT_Kd 122.20
  #endif
#endif
...
#define PRO_B_WITH_LEADSCREW
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.62, 80.62, 414.16, 105 }
#else                                   // M8 threaded rod version
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.62, 80.62, 2560, 105 }
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -18.6, -44.5, -4.45 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 138.69
  #define XY_DIAG_BD 138.75
  #define XY_SIDE_AD 100.94
